...
ℹ️ _Les indexes GIN ne sont pas visibles via OpenAPI — vérification à faire côté Supabase Studio ou via une RPC custom._
...
ℹ️ _Indexes secondaires et contraintes UNIQUE non-PK : invisibles via OpenAPI._
